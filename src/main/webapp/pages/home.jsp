				...
				<div class="header-data">
					...
					<nav>
						<ul>
							...
							<li>
								<a href="index.html#" title="" class="not-box-openm">
							...
							<li>
								<a href="index.html#" title="" class="not-box-open">
								...
								<div class="notification-box noti" id="notification">
									...
									<div class="nott-list">
										<div class="notfication-details">
							  				...
							  				<div class="notification-info">
							  					<h3><a href="index.html#" title="">Jassica William</a> Comment on your project.</h3>
							  					<span>2 min ago</span>
							  				</div><!--notification-info -->
						  				</div>
						  				<div class="notfication-details">
						  				...
						  				<div class="view-all-nots">
						  					<a href="index.html#" title="">View All Notification</a>
						  				</div>
									</div><!--nott-list end-->
								</div><!--notification-box end-->
							</li>
									...
									<div class="posts-section">
										<div class="post-bar">
											...
											<div class="epi-sec">
												...
												<ul class="bk-links">
													<li><a href="index.html#" title=""><i class="la la-bookmark"></i></a></li>
													<li><a href="index.html#" title=""><i class="la la-envelope"></i></a></li>
												</ul>
											</div>
											<div class="job_descp">
												...
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam luctus hendrerit metus, ut ullamcorper quam finibus at. Etiam id magna sit amet... <a href="index.html#" title="">view more</a></p>
												<ul class="skill-tags">
											...
											<div class="job-status-bar">
												<ul class="like-com">
													...
													<li><a href="index.html#" class="com"><i class="fas fa-comment-alt"></i> Comment 15</a></li>
												</ul>
											...
											<div class="profiles-slider">
												<div class="user-profy">
													...
													<ul>
														...
														<li><a href="index.html#" title="" class="envlp"><img src="../images/envelop.png" alt=""></a></li>
														...
														<li>
															<div class="comment-list">
																...
																<div class="comment">
																	...
																	<span><img src="../images/clock.png" alt=""> 3 min ago</span>
																	<p>Lorem ipsum dolor sit amet, </p>
																	<a href="index.html#" title="" class="active"><i class="fa fa-reply-all"></i>Reply</a>
																</div>
																...
																<li>
																	<div class="comment-list">
																		...
																		<div class="comment">
																			...
																			<span><img src="../images/clock.png" alt=""> 3 min ago</span>
																			<p>Hi John </p>
																			<a href="index.html#" title=""><i class="fa fa-reply-all"></i>Reply</a>
																		</div>
																	</div><!--comment-list end-->
																</li>
															</ul>
