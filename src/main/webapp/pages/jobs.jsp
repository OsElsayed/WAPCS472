								...
								<div class="notification-box noti" id="notification">
									...
									<div class="nott-list">
										<div class="notfication-details">
							  				...
							  				<div class="notification-info">
							  					<h3><a href="jobs.jsp#" title="">Jassica William</a> Comment on your project.</h3>
							  					<span>2 min ago</span>
							  				</div><!--notification-info -->
						  				</div>
						  				<div class="notfication-details">
									...
									<div class="posts-section">
										<div class="post-bar">
											<div class="post_topbar">
												...
												<div class="ed-opts">
													<a href="jobs.jsp#" title="" class="ed-opts-open"><i class="la la-ellipsis-v"></i></a>
													<ul class="ed-options">
														<li><a href="jobs.jsp#" title="">Edit Post</a></li>
														<li><a href="jobs.jsp#" title="">Unsaved</a></li>
														<li><a href="jobs.jsp#" title="">Unbid</a></li>
														<li><a href="jobs.jsp#" title="">Close</a></li>
														<li><a href="jobs.jsp#" title="">Hide</a></li>
													</ul>
												</div>
											</div>
											<div class="epi-sec">
												...
												<ul class="bk-links">
													<li><a href="jobs.jsp#" title=""><i class="la la-bookmark"></i></a></li>
													<li><a href="jobs.jsp#" title=""><i class="la la-envelope"></i></a></li>
												</ul>
											</div>
											<div class="job_descp">
												<h3>Senior Wordpress Developer</h3>
												<ul class="job-dt">
													<li><a href="jobs.jsp#" title="">Full Time</a></li>
													<li><span>$30 / hr</span></li>
												</ul>
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam luctus hendrerit metus, ut ullamcorper quam finibus at. Etiam id magna sit amet... <a href="jobs.jsp#" title="">view more</a></p>
												<ul class="skill-tags">
													<li><a href="jobs.jsp#" title="">HTML</a></li>
													<li><a href="jobs.jsp#" title="">PHP</a></li>
													<li><a href="jobs.jsp#" title="">CSS</a></li>
													<li><a href="jobs.jsp#" title="">Javascript</a></li>
													<li><a href="jobs.jsp#" title="">Wordpress</a></li>
												</ul>
											</div>
											<div class="job-status-bar">
												<ul class="like-com">
													<li>
														<a href="jobs.jsp#" class="active"><i class="fas fa-heart"></i> Like</a>
														<img src="images/liked-img.png" alt="">
														<span>25</span>
													</li>
													<li><a href="jobs.jsp#" class="com"><i class="fas fa-comment-alt"></i> Comments 15</a></li>
												</ul>
												<a href="jobs.jsp#"><i class="fas fa-eye"></i>Views 50</a>
											</div>
										</div><!--post-bar end-->
										<div class="post-bar">
											<div class="post_topbar">
