				...
				<div class="header-data">
					...
					<nav>
						<ul>
							...
							<li>
								<a href="companies.jsp#" title="" class="not-box-openm">
								...
								<div class="notification-box msg" id="message">
									<div class="nt-title">
										<h4>Setting</h4>
										<a href="companies.jsp#" title="">Clear all</a>
									</div>
									<div class="nott-list">
							...
							<li>
								<a href="companies.jsp#" title="" class="not-box-open">
								...
								<div class="notification-box noti" id="notification">
									...
									<div class="nott-list">
										<div class="notfication-details">
							  				...
							  				<div class="notification-info">
							  					<h3><a href="companies.jsp#" title="">Jassica William</a> Comment on your project.</h3>
							  					<span>2 min ago</span>
							  				</div><!--notification-info -->
						  				</div>
						  				<div class="notfication-details">
						  				...
						  				<div class="view-all-nots">
						  					<a href="companies.jsp#" title="">View All Notification</a>
						  				</div>
									</div><!--nott-list end-->
								</div><!--notification-box end-->
							</li>
					...
					<div class="menu-btn">
						<a href="companies.jsp#" title=""><i class="fa fa-bars"></i></a>
					</div><!--menu-btn end-->
					<div class="user-account">
						<div class="user-info">
							<img src="images/resources/user.png" alt="">
							<a href="companies.jsp#" title="">John</a>
						...
						<div class="user-account-settingss">
							...
							<ul class="us-links">
								...
								<li><a href="companies.jsp#" title="">Privacy</a></li>
								<li><a href="companies.jsp#" title="">Faqs</a></li>
								<li><a href="companies.jsp#" title="">Terms & Conditions</a></li>
							</ul>
						...
						<div class="col-lg-3 col-md-4 col-sm-6">
							<div class="company_profile_info">
								<div class="company-up-info">
									...
									<ul>
										<li><a href="companies.jsp#" title="" class="follow">Follow</a></li>
										<li><a href="companies.jsp#" title="" class="message-us"><i class="fa fa-envelope"></i></a></li>
									</ul>
								</div>
								<a href="company-profile.jsp" title="" class="view-more-pro">View Profile</a>
			...
			<div class="footy-sec mn no-margin">
				<div class="container">
					<ul>
						...
						<li><a href="companies.jsp#" title="">Privacy Policy</a></li>
						<li><a href="companies.jsp#" title="">Community Guidelines</a></li>
						<li><a href="companies.jsp#" title="">Cookies Policy</a></li>
						<li><a href="companies.jsp#" title="">Career</a></li>
						<li><a href="forum.jsp" title="">Forum</a></li>
						<li><a href="companies.jsp#" title="">Language</a></li>
						<li><a href="companies.jsp#" title="">Copyright Policy</a></li>
					</ul>
