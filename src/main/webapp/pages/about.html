				...
				<div class="header-data">
					...
					<nav>
						<ul>
							...
							<li>
								<a href="about.html#" title="" class="not-box-openm">
								...
								<div class="notification-box msg" id="message">
									<div class="nt-title">
										<h4>Setting</h4>
										<a href="about.html#" title="">Clear all</a>
									</div>
									<div class="nott-list">
							...
							<li>
								<a href="about.html#" title="" class="not-box-open">
								...
								<div class="notification-box noti" id="notification">
									...
									<div class="nott-list">
										<div class="notfication-details">
							  				...
							  				<div class="notification-info">
							  					<h3><a href="about.html#" title="">Jassica William</a> Comment on your project.</h3>
							  					<span>2 min ago</span>
							  				</div><!--notification-info -->
						  				</div>
						  				<div class="notfication-details">
						  				...
						  				<div class="view-all-nots">
						  					<a href="about.html#" title="">View All Notification</a>
						  				</div>
									</div><!--nott-list end-->
								</div><!--notification-box end-->
							</li>
					...
					<div class="menu-btn">
						<a href="about.html#" title=""><i class="fa fa-bars"></i></a>
					</div><!--menu-btn end-->
					<div class="user-account">
						<div class="user-info">
							<img src="images/resources/user.png" alt="">
							<a href="about.html#" title="">John</a>
						...
						<div class="user-account-settingss">
							...
							<ul class="us-links">
								...
								<li><a href="about.html#" title="">Privacy</a></li>
								<li><a href="about.html#" title="">Faqs</a></li>
								<li><a href="about.html#" title="">Terms & Conditions</a></li>
							</ul>
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-12">
						<div class="blog">
							...
							<a href="about.html#">Join Our Team</a>
						</div>
					</div>
					<div class="col-md-4 col-sm-12">
						<div class="blog">
							...
							<h2>Help Forum</h2>
							<a href="about.html#">Visit Help Forum</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="footy-sec mn no-margin">
				<div class="container">
					<ul>
						...
						<li><a href="about.html#" title="">Community Guidelines</a></li>
						<li><a href="about.html#" title="">Cookies Policy</a></li>
						<li><a href="about.html#" title="">Career</a></li>
						<li><a href="forum.html" title="">Forum</a></li>
						<li><a href="about.html#" title="">Language</a></li>
						<li><a href="about.html#" title="">Copyright Policy</a></li>
					</ul>
